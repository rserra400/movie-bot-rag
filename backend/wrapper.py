...
_PT_EN_SEARCH = [
    ...
    (r'\bcomédia\s+romântica\b|\bcomedia\s+romantica\b',        'romantic comedy'),
    (r'\bde drama\b',                                           'drama'),
    ...
    (r'\bthriller\s+psicológico\b|\bthriller\s+psicologico\b', 'psychological thriller'),
    (r'\bde guerra\b',                                          'war'),
    # Super-heróis e heróis
    (r'\bsuper[- ]?herói[ns]?\b|\bsuper[- ]?heroi[ns]?\b',     'superhero marvel dc'),
    (r'\bherói[s]?\b|\bheroi[s]?\b',                           'superhero hero'),
    (r'\bvilão[s]?\b|\bvilao[s]?\b',                           'villain'),
    (r'\bpoderes?\s+especiais?\b',                              'superpower'),
    # Franchises PT→EN (para quando chegam ao search em vez do franchise)
    (r'\bvingador(?:es|a|as)?\b',                              'avengers superhero'),
    (r'\bguerra\s+das\s+estrelas\b',                           'star wars'),
    (r'\bsenhor\s+dos\s+anéis\b|\bsenhor\s+dos\s+aneis\b',     'lord of the rings'),
    (r'\bhomem[- ]aranha\b',                                   'spider-man'),
    (r'\bhomem[- ]de[- ]ferro\b',                              'iron man'),
    (r'\bcapitão\s+am[eé]rica\b|\bcapitao\s+am[eé]rica\b',     'captain america'),
    (r'\bplaneta\s+dos\s+macacos\b',                           'planet of the apes'),
    # Temas frequentes em falta
    (r'\bviagem\s+no\s+tempo\b',                               'time travel'),
    (r'\binvasão\s+alien[ií]gena\b|\binvasao\s+alienigena\b',  'alien invasion'),
    (r'\balien[ií]gena[s]?\b',                                 'alien extraterrestrial'),
    (r'\brobô[s]?\b|\brobo[s]?\b',                             'robot'),
    (r'\bvampiro[s]?\b',                                       'vampire'),
    (r'\bzumbi[s]?\b|\bzombie[s]?\b',                          'zombie'),
    (r'\bespião\b|\bespiã[o]?\b|\bespionagem\b',               'spy espionage'),
    (r'\bpiratas?\b',                                          'pirates'),
    (r'\bninja[s]?\b',                                         'ninja'),
    (r'\bsamurai[s]?\b',                                       'samurai'),
    (r'\bcowboy[s]?\b|\bfaroeste\b',                           'cowboy western'),
    (r'\bcorrida[s]?\s+de\s+carros?\b|\bcorridas?\b',          'car racing'),
    (r'\bheis+t\b|\broubo\b',                                  'heist'),
    (r'\bapocalipse\b|\bfim\s+do\s+mundo\b',                   'apocalypse end of world'),
    (r'\bsobrevivência\b|\bsobrevivencia\b',                   'survival'),
    (r'\bmagia\b|\bfeitiçaria\b|\bfeiticaria\b',               'magic sorcery'),
    (r'\bmediev[ae]l\b',                                       'medieval'),
    (r'\bpós[- ]apocal\w+\b|\bpos[- ]apocal\w+\b',            'post apocalyptic'),
    # Preposições e verbos de pesquisa a remover
    (r'\bsobre drogas\b',                                      'drugs narcotics addiction'),
    (r'\bsobre amor\b',                                        'love romance'),
    (r'\bsobre família\b|\bsobre familia\b',                   'family'),
